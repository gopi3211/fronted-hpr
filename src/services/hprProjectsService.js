...
export const getGalleryByCategory = (category) =>
  axiosInstance.get(`/hpr-projects/gallery-category/${category}`);

// -------------------- HOME TAB --------------------
export const createHome = (data) => axiosInstance.post(`/hpr-projects/home`, data);
export const getHomeByProjectId = (projectId) =>
  axiosInstance.get(`/hpr-projects/home/${projectId}`);
...
// -------------------- GALLERY TAB (image_url based) --------------------
export const addGalleryImage = (data) => axiosInstance.post(`/hpr-projects/gallery`, data);
export const getGalleryByProjectId = (projectId) =>
  axiosInstance.get(`/hpr-projects/gallery/${projectId}`);
export const updateGalleryImage = (id, data) =>
  axiosInstance.put(`/hpr-projects/gallery/${id}`, data);
export const deleteGalleryImage = (id) => axiosInstance.delete(`/hpr-projects/gallery/${id}`);

// -------------------- PLAN TAB (file_url based) --------------------
export const addPlan = (data) => axiosInstance.post(`/hpr-projects/plan`, data);
export const getPlanByProjectId = (projectId) =>
  axiosInstance.get(`/hpr-projects/plan/${projectId}`);
export const updatePlan = (id, data) =>
  axiosInstance.put(`/hpr-projects/plan/${id}`, data);
export const deletePlan = (id) => axiosInstance.delete(`/hpr-projects/plan/${id}`);

// -------------------- LOCATION TAB --------------------
export const addLocation = (data) => axiosInstance.post(`/hpr-projects/location`, data);
...
export const deleteLocation = (id) => axiosInstance.delete(`/hpr-projects/location/${id}`);

// -------------------- AMENITIES TAB --------------------
export const createAmenities = (data) => axiosInstance.post(`/hpr-projects/amenities`, data);
export const getAmenitiesByProjectId = (projectId) =>
  axiosInstance.get(`/hpr-projects/amenities/${projectId}`);
export const updateAmenities = (id, data) =>
  axiosInstance.put(`/hpr-projects/amenities/${id}`, data);
